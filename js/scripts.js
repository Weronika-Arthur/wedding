$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Ślub Weronika i Arthura",

            // Event start date
            start: new Date('Aug 27, 2022 15:00'),
            ...
            end: new Date('Aug 28, 2022 05:00'),

            // Event Address
            address: 'Kościół pw. św. Ojca Pio, Rybałtów 25, 02-886 Warszawa',

            // Event Description
            description: "Nie możemy się doczekać, aby zobaczyć Cię na naszym ślubie!"
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 52.13077301827938, lng: 21.055213308713064};
...
function initBBSRMap() {
    var la_fiesta = {lat: 52.13077301827938, lng: 21.055213308713064};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
